...
// ====== SPRITES (без атласа) ======
const SPRITES = {
  down:       { url: `assets/sprite_down.png?v=${VER}`,       frameW: 344, frameH: 464, frames: 20, fps: 12 },
  right:      { url: `assets/sprite_right.png?v=${VER}`,      frameW: 344, frameH: 464, frames: 24, fps: 12 },
  downRight:  { url: `assets/sprite_down_right.png?v=${VER}`, frameW: 344, frameH: 464, frames: 12, fps: 12 },
  upRight:    { url: `assets/sprite_up_right.png?v=${VER}`,   frameW: 344, frameH: 464, frames: 48, fps: 14 },
  up:         { url: `assets/sprite_up.png?v=${VER}`,         frameW: 332, frameH: 302, frames: 12, fps: 12 },
  attack:     { url: `assets/sprite_attack.png?v=${VER}`,     frameW: 344, frameH: 392, frames: 32, fps: 16 },
  death:      { url: `assets/sprite_death.png?v=${VER}`,      frameW: 344, frameH: 464, frames: 46, fps: 12 },
};
